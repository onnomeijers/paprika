...
setup(
    ...
    install_requires=['paramiko', 'requests', 'suds', 'filemagic', 'pysmbclient', 'hdfs', 'paprika-connector[mysql,oracle] @ git+https://github.com/oxymabv/paprika-connector@master'],
